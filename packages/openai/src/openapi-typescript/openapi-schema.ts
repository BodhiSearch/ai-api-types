...
export interface components {
    schemas: {
        AdditionalTools: {
            /**
             * @description The type of the item. Always `additional_tools`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
        ...
        AdditionalToolsItemParam: {
            id?: string | null;
            /**
             * @description The item type. Always `additional_tools`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "AdditionalToolsItemParam";
            /**
        ...
        ApplyPatchToolCall: {
            ...
            call_id: string;
            caller?: components["schemas"]["ToolCallCaller"] | null;
        ...
        ApplyPatchToolCallItemParam: {
            ...
            /** @description The unique ID of the apply patch tool call generated by the model. */
            call_id: string;
            caller?: components["schemas"]["ToolCallCallerParam"] | null;
            /** @description The status of the apply patch tool call. One of `in_progress` or `completed`. */
        ...
        ApplyPatchToolParam: {
            ...
            allowed_callers?: components["schemas"]["CallableToolAllowedCaller"][] | null;
        };
        /**
        ...
        ChatCompletionModeration: {
            ...
            input: components["schemas"]["ChatCompletionModerationResults"] | components["schemas"]["ChatCompletionModerationError"];
            /** @description Moderation for the generated output. */
            output: components["schemas"]["ChatCompletionModerationResults"] | components["schemas"]["ChatCompletionModerationError"];
        };
        /** @description An error produced while attempting moderation. */
        ChatCompletionModerationError: {
            /**
             * @description The object type, which is always `error`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ChatCompletionModerationError";
        ...
        ChatCompletionModerationResults: {
            /**
             * @description The object type, which is always `moderation_results`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ChatCompletionModerationResults";
        ...
        ChatCompletionRequestMessageContentPartAudio: {
            ...
            prompt_cache_breakpoint?: components["schemas"]["PromptCacheBreakpointParam"];
        };
        /**
         * File content part
        ...
        CreateChatCompletionResponse: {
            ...
            moderation?: components["schemas"]["ChatCompletionModeration"] | null;
        };
        /**
        ...
        CreateModelResponseProperties: components["schemas"]["ModelResponseProperties"] & {
            prompt_cache_options?: components["schemas"]["PromptCacheOptionsParam"];
            /**
             * @description An integer between 0 and 20 specifying the maximum number of most likely
             *     tokens to return at each token position, each with an associated log
             *     probability. In some cases, the number of returned tokens may be fewer than
        ...
        DirectToolCallCaller: {
             ...
             * @enum {string}
             */
            type: "DirectToolCallCaller";
        };
        DirectToolCallCallerParam: {
            /**
             * @description The caller type. Always `direct`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "DirectToolCallCallerParam";
        };
        /**
         * DoubleClick
        ...
        InputFileContent: {
            ...
            file_data?: string;
            prompt_cache_breakpoint?: components["schemas"]["PromptCacheBreakpointConfig"];
            /**
             * Format: uri
        ...
        InputItem: components["schemas"]["EasyInputMessage"] | components["schemas"]["Item"] | components["schemas"]["CompactionTriggerItemParam"] | components["schemas"]["ItemReferenceParam"] | components["schemas"]["ProgramItemParam"] | components["schemas"]["ProgramOutputItemParam"];
        /**
         * Input message
         * @description A message input to the model with a role indicating instruction following
         *     hierarchy. Instructions given with the `developer` or `system` role take
        ...
        Moderation: {
            ...
            input: components["schemas"]["ModerationResultBody"] | components["schemas"]["ModerationErrorBody"];
            /** @description Moderation for the response output. */
            output: components["schemas"]["ModerationResultBody"] | components["schemas"]["ModerationErrorBody"];
        };
        /** @description The moderation policy for the response input. */
        ModerationConfigParam: {
            mode: components["schemas"]["ModerationMode"];
        };
        /**
         * Moderation error
        ...
        ModerationErrorBody: {
            /**
             * @description The object type, which was always `error` for moderation failures. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ModerationErrorBody";
            /** @description The error code. */
            code: string;
            /** @description The error message. */
            message: string;
        ...
        /** @enum {string} */
        ModerationInputType: "text" | "image";
        /** @enum {string} */
        ModerationMode: "score" | "block";
        ...
        ModerationParam: {
            ...
            model: string;
            policy?: components["schemas"]["ModerationPolicyParam"] | null;
        };
        /** @description The policy to apply to moderated response input and output. */
        ModerationPolicyParam: {
            input?: components["schemas"]["ModerationConfigParam"] | null;
            output?: components["schemas"]["ModerationConfigParam"] | null;
        };
        /**
         * Moderation result
        ...
        ModerationResultBody: {
            /**
             * @description The object type, which was always `moderation_result` for successful moderation results. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ModerationResultBody";
            ...
            category_applied_input_types: {
                [key: string]: components["schemas"]["ModerationInputType"][];
            };
        };
        /**
         * Move
        ...
        Program: {
            /**
             * @description The type of the item. Always `program`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "Program";
        ...
        ProgramItemParam: {
            ...
            id: string;
            /**
             * @description The item type. Always `program`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ProgramItemParam";
            /** @description The stable call ID of the program item. */
            call_id: string;
            /** @description The JavaScript source executed by programmatic tool calling. */
            code: string;
        ...
        ProgramOutput: {
            /**
             * @description The type of the item. Always `program_output`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ProgramOutput";
        ...
        ProgramOutputItemParam: {
            ...
            id: string;
            /**
             * @description The item type. Always `program_output`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ProgramOutputItemParam";
            /** @description The call ID of the program item. */
            call_id: string;
            /** @description The result produced by the program item. */
            result: string;
        ...
        /** @enum {string} */
        ProgramOutputItemStatus: "completed" | "incomplete";
        /** @enum {string} */
        ProgramOutputStatus: "completed" | "incomplete";
        ProgramToolCallCaller: {
            /**
             * @description discriminator enum property added by openapi-typescript
             * @enum {string}
             */
            type: "ProgramToolCallCaller";
            /** @description The call ID of the program item that produced this tool call. */
            caller_id: string;
        };
        ProgramToolCallCallerParam: {
            /**
             * @description The caller type. Always `program`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ProgramToolCallCallerParam";
            /** @description The call ID of the program item that produced this tool call. */
            caller_id: string;
        };
        ProgrammaticToolCallingParam: {
            /**
             * @description The type of the tool. Always `programmatic_tool_calling`. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: "ProgrammaticToolCallingParam";
        };
        Prompt: {
        ...
        Reasoning: {
             ...
             */
            mode?: components["schemas"]["ReasoningModeEnum"];
        ...
        ReasoningModeEnum: string | ("standard" | "pro");
        /**
         * Reasoning text
        ...
        Response: components["schemas"]["ModelResponseProperties"] & components["schemas"]["ResponseProperties"] & {
            ...
            prompt_cache_options?: components["schemas"]["PromptCacheOptions"];
            ...
            conversation?: components["schemas"]["ResponseConversation"] | null;
            max_output_tokens?: number | null;
        };
        ...
        Tool: components["schemas"]["FunctionTool"] | components["schemas"]["FileSearchTool"] | components["schemas"]["ComputerTool"] | components["schemas"]["ComputerUsePreviewTool"] | components["schemas"]["WebSearchTool"] | components["schemas"]["MCPTool"] | components["schemas"]["CodeInterpreterTool"] | components["schemas"]["ProgrammaticToolCallingParam"] | components["schemas"]["ImageGenTool"] | components["schemas"]["LocalShellToolParam"] | components["schemas"]["FunctionShellToolParam"] | components["schemas"]["CustomToolParam"] | components["schemas"]["NamespaceToolParam"] | components["schemas"]["ToolSearchToolParam"] | components["schemas"]["WebSearchPreviewTool"] | components["schemas"]["ApplyPatchToolParam"];
        /** @description The execution context that produced this tool call. */
        ToolCallCaller: components["schemas"]["DirectToolCallCaller"] | components["schemas"]["ProgramToolCallCaller"];
        /** @description The execution context that produced this tool call. */
        ToolCallCallerParam: components["schemas"]["DirectToolCallCallerParam"] | components["schemas"]["ProgramToolCallCallerParam"];
        /**
         * Allowed tools
         * @description Constrains the tools available to the model to a pre-defined set.
         */
