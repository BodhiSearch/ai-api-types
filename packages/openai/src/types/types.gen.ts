...
export type ApplyPatchToolCallItemParam = {
     ...
     */
    call_id: string;
    caller?: ToolCallCallerParam | null;
    /**
     * The status of the apply patch tool call. One of `in_progress` or `completed`.
     */
...
export type CreateChatCompletionResponse = {
    ...
    moderation?: ChatCompletionModeration | null;
};
...
export type ModerationParam = {
     ...
     */
    model: string;
    policy?: ModerationPolicyParam | null;
};
...
export type ModerationPolicyParam = {
    input?: ModerationConfigParam | null;
    output?: ModerationConfigParam | null;
};
...
export type ModerationResultBody = {
    ...
    category_applied_input_types: {
        [key: string]: Array<ModerationInputType>;
    };
};
 ...
 * The execution context that produced this tool call.
 */
export type ToolCallCallerParam = ({
 ...
 *
 */
export type ToolChoiceParam = ToolChoiceOptions | ToolChoiceAllowed | ToolChoiceTypes | ToolChoiceFunction | ToolChoiceMcp | ToolChoiceCustom | SpecificProgrammaticToolCallingParam | SpecificApplyPatchParam | SpecificFunctionShellParam;
